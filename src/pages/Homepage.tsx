...
import childrenLearning2 from '@/assets/children-learning-2.jpg';
import tableSettingActivity from '@/assets/table-setting-1.jpg';
              ...
              <Card key={index} className="card-hover overflow-hidden">
                ...
                <CardContent className="p-6">
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold text-primary mb-2">{programme.level}</h3>
